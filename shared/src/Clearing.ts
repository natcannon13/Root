...
export class Clearing extends Location {
    ...
    constructor(args: { id: number; printedSuit: Suit | null; slotCount: number }) {
        super();
        this.id = args.id;
    ...
    replace(oldPiece: Piece, newPiece: Piece, targetSlot: number = 0): void { }
